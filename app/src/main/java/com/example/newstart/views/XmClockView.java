 ...
 * Camera：仿小米时钟
 */
public class XmClockView extends RelativeLayout {
    ...
    public XmClockView(Context context) {
        super(context);
    }

    public XmClockView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public XmClockView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
